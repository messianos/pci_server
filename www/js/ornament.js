...
/*
	...
	appendOrnamentFrame($('#container'), frame_dimensions, block_dimensions, block_decorations, color_set);

*/

function appendOrnamentFrame(container, frame_dimensions, block_dimensions, block_decorations, color_set) {
	...
	appendOrnament(top_ornament, frame_width, frame_top_side_height, block_dimensions, block_decorations, color_set);
	...
	appendOrnament(left_ornament, frame_left_side_width, frame_height - frame_top_side_height - frame_bottom_side_height, block_dimensions, block_decorations, color_set);
	...
	appendOrnament(right_ornament, frame_right_side_width, frame_height - frame_top_side_height - frame_bottom_side_height, block_dimensions, block_decorations, color_set);

	var bottom_ornament = $('<div></div>');
	bottom_ornament.css('position', 'absolute');
	bottom_ornament.css('bottom', 0);
	bottom_ornament.css('left', 0);
	appendOrnament(bottom_ornament, frame_width, frame_bottom_side_height, block_dimensions, block_decorations, color_set);
...
function appendOrnament(container, width, height, block_dimensions, block_decorations, color_set) {
	...
	appendBlocks(container, width, height, block_dimensions, block_decorations, block_colors);
}

function appendBlocks(container, width, height, block_dimensions, block_decorations, block_colors) {
