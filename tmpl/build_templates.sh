...
cppcms_tmpl_cc Template.tmpl Debug.tmpl Error404.tmpl Index.tmpl Problems.tmpl Problem.tmpl NewProblem.tmpl User.tmpl Solution.tmpl NewSolution.tmpl Ideas.tmpl -o $OUTPUT_FILE
