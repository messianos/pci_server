...
cppcms_tmpl_cc Template.tmpl Index.tmpl SignIn.tmpl SignUp.tmpl Problems.tmpl Problem.tmpl NewProblem.tmpl User.tmpl Solution.tmpl Ideas.tmpl -o $OUTPUT_FILE
